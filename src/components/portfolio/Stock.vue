    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        <div class="pull-left">
          ...
          <input v-model.number="quantity" type="number" :class="{danger: insufficientQuantity}" placeholder="Quantity">
        </div>
        <div class="pull-right">
          ...
          <button class="btn btn-success" @click="sellStock" :disabled="insufficientQuantity">
